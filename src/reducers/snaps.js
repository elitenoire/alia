import { GET_SNAPS_PASS, GET_SNAPS_FAIL, DELETE_SNAP_CACHE, DELETE_SNAP_FAIL,
    ...
    TOGGLE_DELETE_MODAL, SELECT_SNAP } from '../constants'

const INITIAL_STATE = { isFetching : true, snaps : {}, error : '', deleteModal : false, color : '' }

export default (state = INITIAL_STATE, { type, error, snaps, snap, id, toggle, color }) => {
    switch(type){
        case GET_SNAPS_PASS :
